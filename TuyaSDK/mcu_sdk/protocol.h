...
******************************************************************************/
#define PRODUCT_KEY "ojmowyfw"    //开发平台创建产品后生成的16位字符产品唯一标识
...
//实时计数(只上报)
//备注:
#define DPID_COUNT_REALTIME 4
//实时计时(只上报)
//备注:
#define DPID_TIME_REALTIME 5
//实时卡路里(只上报)
//备注:
#define DPID_CALORIES_REALTIME 6
//实时跳绳速度(只上报)
//备注:
#define DPID_SPEED_REALTIME 7
//总跳绳个数(只上报)
//备注:
#define DPID_COUNT_TOTAL 8
//总时长(只上报)
//备注:
#define DPID_TIME_TOTAL 9
//总卡路里(只上报)
//备注:
#define DPID_CALORIES_TOTAL 10
//目标时间(可下发可上报)
//备注:
#define DPID_TARGET_TIME 14
//目标个数(可下发可上报)
//备注:
#define DPID_TARGET_COUNT 15
//电池电量(只上报)
//备注:
#define DPID_BATTERY_STATE 16
//体重(可下发可上报)
//备注:
#define DPID_WEIGHT 17
//性别(可下发可上报)
//备注:
#define DPID_GENDER 18
//身高(可下发可上报)
//备注:
#define DPID_HEIGHT 19
