...
static void hal_rfphy_init(void)
{
    ...
    g_rfPhyFreqOffSet   =RF_PHY_FREQ_FOFF_00KHZ; //RF_PHY_FREQ_FOFF_N120KHZ
    //============config xtal 16M cap
...
void ty_sleep_handler(void)
{
}

void ty_wakeup_handler(void)
{
    osal_set_event(simpleBLEPeripheral_TaskID, SBP_TUYA_EXEC_EVT);
}
...
int  main(void)
{
    ...
    TY_PRINTF("sizeof(struct ll_pkt_desc) = %d, buf size = %d", sizeof(struct ll_pkt_desc), BLE_CONN_BUF_SIZE);
